...
#define MARIO_ANI_BIG_IDLE_UP			2
#define MARIO_ANI_BIG_IDLE_DOWN			3
#define MARIO_ANI_SMALL_IDLE_RIGHT		4
#define MARIO_ANI_SMALL_IDLE_LEFT		5



#define MARIO_ANI_BIG_WALKING_RIGHT			6
#define MARIO_ANI_BIG_WALKING_LEFT			7
#define MARIO_ANI_BIG_WALKING_UP			8
#define MARIO_ANI_BIG_WALKING_DOWN			9
...
#define MARIO_BIG_BBOX_WIDTH  20
