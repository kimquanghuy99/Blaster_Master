...
CSOPHIAWHEEL::CSOPHIAWHEEL(int part)
{
	this->part = part;
}

void CSOPHIAWHEEL::GetBoundingBox(float& left, float& top, float& right, float& bottom)
{
}

void CSOPHIAWHEEL::Update(DWORD dt, vector<LPGAMEOBJECT>* coObjects)
{
...
void CSOPHIAWHEEL::SetState(int state)
{
